...
const plans = [
  {
    name: "Free",
    price: "0",
    description: "Get started with basic money tracking",
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      "Goal-based saving (car, house, etc.)",
    ],
    mostPopular: true,
  },
  {
    name: "Premium",
    price: "19.99",
    description: "Full control of your financial life",
    features: [
      "Everything in Pro",
      "Multi-account sync (banks & cards)",
      "Investment tracking",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          ...
          <p className="text-gray-400 text-base text-xl sm:text-lg max-w-2xl mx-auto">
            Choose the plan that helps you save more, spend smarter, and stay in
